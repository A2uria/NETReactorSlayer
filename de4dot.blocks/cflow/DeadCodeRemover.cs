    ...
    class DeadCodeRemover : BlockDeobfuscator
    {
        ...
        class InstructionExpressionFinder
        {
            ...
            public bool Find(int index)
            {
                ...
                var stack = new List<FindFrame>
                {
                    new() { Needed = neededInitial, AddIt = true },
                };
                    ...
                    if (!f.IsResumption)
                    {
                        ...
                        if (f.Needed != 0 && _index > 0)
                        {
                            ...
                            if (pops > 0)
                            {
                                ...
                                {
                                    stack.Add(
                                        new FindFrame { Needed = childNeeded, AddIt = childAddIt }
                                    );
