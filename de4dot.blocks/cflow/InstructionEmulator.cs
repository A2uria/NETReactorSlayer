    ...
    public class InstructionEmulator
    {
        ...
        public void Emulate(Instruction instr)
        {
            switch (instr.OpCode.Code)
            {
                ...
                case Code.Newarr:
                    Emulate_Newarr(instr);
                    break;
                case Code.Stelem_I1:
                case Code.Stelem_I2:
                case Code.Stelem_I4:
                    Emulate_Stelem_I1I2I4(instr);
                    break;
                case Code.Ldelem_I1:
                case Code.Ldelem_U1:
                case Code.Ldelem_I2:
                ...
                case Code.Ldelem_I4:
                case Code.Ldelem_U4:
                    Emulate_Ldelem_IU1IU2IU4(instr);
                    break;
        ...
        void Emulate_Sizeof(Instruction instr)
        {
            if (instr.Operand is ITypeDefOrRef tdr)
            {
                ...
                {
                    case "System.Double":
                        valueStack.Push(new Int32Value(sizeof(System.Double)));
                        return;
                    case "System.Int16":
                        valueStack.Push(new Int32Value(sizeof(System.Int16)));
                        return;
                    case "System.Int32":
                        valueStack.Push(new Int32Value(sizeof(System.Int32)));
                        return;
                    case "System.Int64":
                        valueStack.Push(new Int32Value(sizeof(System.Int64)));
                        return;
                    case "System.Single":
                        valueStack.Push(new Int32Value(sizeof(System.Single)));
                        return;
                    case "System.UInt16":
                        valueStack.Push(new Int32Value(sizeof(System.UInt16)));
                        return;
                    case "System.UInt32":
                        valueStack.Push(new Int32Value(sizeof(System.UInt32)));
                        return;
                    case "System.UInt64":
                        valueStack.Push(new Int32Value(sizeof(System.UInt64)));
                        return;
                    case "System.Guid":
                        valueStack.Push(new Int32Value(16));
                        return;
                    case "System.Byte":
                        valueStack.Push(new Int32Value(sizeof(System.Byte)));
                        return;
                }
            }
            valueStack.Push(Int32Value.CreateUnknown());
        ...
        void Emulate_Ldlen(Instruction instr)
        {
            ...
            valueStack.Push(
                obj is ObjectValue { obj: List<Value> arr }
        ...
        void Emulate_Stelem_I1I2I4(Instruction instr)
        {
            ...
            var obj = valueStack.Pop();
            if (
                val is Int32Value valI32
                && idxValue is Int32Value idx
                && idx.AllBitsValid()
                && obj is ObjectValue { obj: List<Value> arr }
                && idx.Value >= 0
                && arr.Count > idx.Value
