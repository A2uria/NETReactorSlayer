...
namespace NETReactorSlayer.De4dot.Renamer
{
    public class PropertyNameCreator : TypeNames
    {
        ...
        private static readonly Dictionary<string, string> OurFullNameToShortName = new(
            StringComparer.Ordinal
        );

        private static readonly Dictionary<string, string> OurFullNameToShortNamePrefix = new(
            StringComparer.Ordinal
        );
    }
}
